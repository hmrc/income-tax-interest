...
object DeleteSavingsIncomeDataParser extends DESParser with Logging {
  type DeleteSavingsIncomeDataResponse = Either[DesErrorModel, Boolean]

  override val parserName: String = "DeleteSavingsIncomeDataParser"
